          ...
          <Col md={4} xs={6} className="tera-box-card">
            <Card className="card card-box pt-4 pb-4 pe-4">
              <Card.Body>
                ...
                <Card.Text>
                  Simplest platform to start trading cryptocurrencies with no
                  prior experience.
                </Card.Text>
              </Card.Body>
            </Card>
          ...
          <Col md={4} xs={6} className="tera-box-card">
            <Card className="card card-box pt-4 pb-4 pe-4">
              <Card.Body>
                ...
                <Card.Text>
                  Create your own portfolio, or invest in decetralised staking
                  pools to earn attractive interest rates.
                </Card.Text>
              </Card.Body>
            </Card>
          </Col>
          <Col md={4} xs={6} className="tera-box-card">
            <Card className="card card-box pt-4 pb-4 pe-4">
              <Card.Body>
                ...
                <Card.Text>
                  Keep things simple with no extra subscription or management
                  fees, only pay standard trading fees.
                </Card.Text>
              </Card.Body>
            </Card>
          </Col>
          <Col md={4} xs={6} className="tera-box-card">
            <Card className="card card-box pt-4 pb-4 pe-4">
              <Card.Body>
                ...
                <Card.Text>
                  Connect all Web3 wallets and manage your decentalised
          ...
          <Col md={4} xs={6} className="tera-box-card">
            <Card className="card card-box pt-4 pb-4 pe-4">
              <Card.Body>
                ...
                <Card.Text>
                  Easily buy cryptocurrencies with bank card directly to a web3
                  wallet.
                </Card.Text>
              </Card.Body>
            </Card>
          ...
          <Col md={4} xs={6} className="tera-box-card">
            <Card className="card card-box pt-4 pb-4 pe-4">
              <Card.Body>
                ...
                <Card.Text>
                  Your crypto in your control! You retain full custody of your
                  funds at all times.
                </Card.Text>
              </Card.Body>
            </Card>
