      ...
      <Container>
        <Row>
          <div className="heading-sec">
            <h1>
              Buy crypto instantly to your Web3 wallet <span></span>
            </h1>
            <p>
              Securely buy, sell, invest, track and transfer cryptocurrencies
            </p>
          </div>
          ...
          <div className="buy-table">
            <Table responsive="sm">
              <thead>
                <td className="table-top-heading" colSpan={6}>
                  Trending Market
                </td>
